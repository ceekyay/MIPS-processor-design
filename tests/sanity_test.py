 ...
 ("ALU addu test",
  ...
  ("RegFile read/write test",
   ...
   ("RegFile $zero test",
         TestCase(os.path.join(file_locations,'regfile-zero.circ'),
                  os.path.join(file_locations,'reference_output/regfile-zero.out')), "regfile"),
   ("RegFile debugOutputs test",
         TestCase(os.path.join(file_locations,'regfile-debugOutputs.circ'),
                  os.path.join(file_locations,'reference_output/regfile-debugOutputs.out')), "regfile"),
   ("RegFile allRegsWriteRead test",
           TestCase(os.path.join(file_locations,'regfile-allRegsWriteRead.circ'),
                  os.path.join(file_locations,'reference_output/regfile-allRegsWriteRead.out')), "regfile"),
   ("RegFile allRegsTestMaxData test",
           TestCase(os.path.join(file_locations,'regfile-allRegsTestMaxData.circ'),
                 os.path.join(file_locations,'reference_output/regfile-allRegsTestMaxData.out')), "regfile"),   
]
